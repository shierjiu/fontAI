  ...
  <div class="dataset-container">
    ...
    <div class="drawer-footer">
      ...
      <el-button type="primary" @click="MultFileonSubmit">开始上传</el-button>
        ...
        <!-- 文件导入 -->
        <el-drawer v-model="fileDrawerVisible" title="文件导入" width="20%" direction="rtl" size="30%" destroy-on-close class="custom-drawer">
          <!-- ============ 回显区 ============ -->
...
const panelWidth  = computed(() => (isCollapsed.value ? 0 : 300))
